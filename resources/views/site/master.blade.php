        ...
        <div class="navbar-area">
            ...
            <div class="mobile-nav">
                <a href="index.html" class="logo">
                    <img src="{{ asset('site/assets/img/logos/logo-1.png') }}" class="logo-one" alt="Logo">
                    <img src="{{ asset('site/assets/img/logos/footer-logo1.png') }}" class="logo-two" alt="Logo">
                </a>
            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-widget">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{ asset('site/assets/img/logos/footer-logo1.png') }}" alt="Images">
                                    </a>
                                </div>
                                <p>
