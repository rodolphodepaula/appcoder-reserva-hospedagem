                      ...
                      <div class="col-lg-5 col-md-4 p-0">
                          <div class="room-card-img">
                              <a href="room-details.html">
                                  <img src="{{ asset('site/assets/img/room/room-style-img1.jpg') }}" alt="Images">
                              </a>
                          </div>
                      </div>
              ...
              <div class="room-card-two">
                  <div class="row align-items-center">
                      <div class="col-lg-5 col-md-4 p-0">
                          <div class="room-card-img">
                              <a href="room-details.html">
                                  <img src="{{ asset('site/assets/img/room/room-style-img2.jpg') }}" alt="Images">
                              </a>
                          </div>
                      </div>
              ...
              <div class="room-card-two">
                  <div class="row align-items-center">
                      <div class="col-lg-5 col-md-4 p-0">
                          <div class="room-card-img">
                              <a href="room-details.html">
                                  <img src="{{ asset('site/assets/img/room/room-style-img3.jpg') }}" alt="Images">
                              </a>
                          </div>
                      </div>
              ...
              <div class="room-card-two">
                  <div class="row align-items-center">
                      <div class="col-lg-5 col-md-4 p-0">
                          <div class="room-card-img">
                              <a href="room-details.html">
                                  <img src="{{ asset('site/assets/img/room/room-style-img4.jpg') }}" alt="Images">
                              </a>
                          </div>
                      </div>
      ...
      <div class="row align-items-center">
          ...
          <div class="col-lg-6">
              <div class="book-img-2">
                  <img src="{{ asset('site/assets/img/book-img2.jpg') }}" alt="Images">
              </div>
          </div>
      </div>
  </div>
...
<div class="team-area-three pt-100 pb-70">
  <div class="container">
      ...
      <div class="team-slider-two owl-carousel owl-theme pt-45">
          <div class="team-item">
              <a href="team.html">
                  <img src="{{ asset('site/assets/img/team/team-img1.jpg') }}" alt="Images">
              </a>
              <div class="content">
          ...
          <div class="team-item">
              <a href="team.html">
                  <img src="{{ asset('site/assets/img/team/team-img2.jpg') }}" alt="Images">
              </a>
              <div class="content">
          ...
          <div class="team-item">
              <a href="team.html">
                  <img src="{{ asset('site/assets/img/team/team-img5.jpg') }}" alt="Images">
              </a>
              <div class="content">
          ...
          <div class="team-item">
              <a href="team.html">
                  <img src="{{ asset('site/assets/img/team/team-img4.jpg') }}" alt="Images">
              </a>
              <div class="content">
      ...
      <div class="row align-items-center pt-45">
          <div class="col-lg-6 col-md-6">
              <div class="testimonials-img-two">
                  <img src="{{ asset('site/assets/img/testimonials/testimonials-img5.jpg') }}" alt="Images">
              </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6">
              <div class="testimonials-slider-area owl-carousel owl-theme">
                  <div class="testimonials-slider-content">
                      ...
                      <ul>
                          <li>
                              <img src="{{ asset('site/assets/img/testimonials/testimonials-img1.jpg') }}" alt="Images">
                              <h3>Mary Marden</h3>
                  ...
                  <div class="testimonials-slider-content">
                      ...
                      <ul>
                          <li>
                              <img src="{{ asset('site/assets/img/testimonials/testimonials-img2.jpg') }}" alt="Images">
...
<div class="faq-area pt-100 pb-70 section-bg">
  <div class="container">
      <div class="row align-items-center">
          ...
          <div class="col-lg-6">
              <div class="faq-img-3">
                  <img src="{{ asset('site/assets/img/faq/faq-img3.jpg') }}" alt="Images">
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="container">
      ...
      <div class="row pt-45">
          <div class="col-lg-4 col-md-6">
              <div class="blog-item">
                  <a href="blog-details.html">
                      <img src="{{ asset('site/assets/img/blog/blog-item-img1.jpg') }}" alt="Images">
                  </a>
                  <div class="content">
                      <ul>
          ...
          <div class="col-lg-4 col-md-6">
              <div class="blog-item">
                  <a href="blog-details.html">
                      <img src="{{ asset('site/assets/img/blog/blog-item-img2.jpg') }}" alt="Images">
                  </a>
                  <div class="content">
                      <ul>
          ...
          <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
              <div class="blog-item">
                  <a href="blog-details.html">
                      <img src="{{ asset('site/assets/img/blog/blog-item-img3.jpg') }}" alt="Images">
                  </a>
                  <div class="content">
                      <ul>
